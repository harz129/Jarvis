...
SystemChatBot = [{"role": "system", "content": f"Hello, I am {os.environ['Username']}. You're a content writer. You have to write content like letters, essats, articles, codes, poems, songs, stories, etc."}]

# Function to perform a Google search.
def GoogleSearch(Topic):
    search(Topic)  # Use pywhatkit's search function to perform a Google search.
    return True  # Indicate success.
# GoogleSearch("Python")  # Perform a sample Google search.
...
def YouTubeSearch(Topic):
    ...
    open(Url4Search)  # Open the search URL in a web browser.
    return True  # Indicate success.
# YouTubeSearch("PythonCourse")  # Search for a Python course on YouTube.
# Function to play a video on YouTube.
def PlayYoutube(query):
    playonyt(query)  # Use pywhatkit's playonyt function to play the video.
    return True  # Indicate success.
# PlayYoutube("Python Course")  # Play a sample video on YouTube.
